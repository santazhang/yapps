...
class Generator:
    ...
    def generate_output(self):
        ...
        if self.postparser is not None:
            ...
            self.write(INDENT*2, "sys.stdout.write(str(parse(argv[1], f.read())))\n")
            self.write(INDENT*2, "sys.stdout.write('\\n')\n")
            self.write(INDENT, "else:\n")
            self.write(INDENT*2, "sys.stderr.write('Args:  <rule> [<filename>]')\n")
            self.write(INDENT*2, "sys.stderr.write('\\n')\n")
            self.write("# End -- grammar generated by Yapps\n")
